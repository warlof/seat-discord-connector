...
/**
 * Class DiscordRoleGroup
 * @package Warlof\Seat\Connector\Discord\Models
 */
class DiscordRoleGroup extends Model
{
     ...
     * @var string
     */
    protected $table = 'warlof_discord_connector_role_groups';

    /**
     * @var array
     */
    protected $primaryKey = [
        'group_id', 'discord_role_id',
    ];
     ...
     */
    protected $fillable = [
        'group_id', 'discord_role_id', 'enabled',
    ];
