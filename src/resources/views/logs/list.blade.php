        ...
        <div class="panel-footer clearfix">
            ...
            @else
                <form method="post" action="{{ route('discord-connector.command.run') }}">
                    {{ csrf_field() }}
                    <input name="command_name" type="text" value="discord:logs:clear" class="hidden" />
                    <button type="submit" class="btn btn-danger btn-sm pull-right" role="button">Clear</button>
                </form>
            @endif
        </div>
    </div>
