<table class="table table-condensed table-hover table-responsive">
    ...
    <tbody>
    @foreach($discord_role_filters as $filter)
        <tr>
            ...
            <td>
                <div class="btn-group">
                    <a href="{{ route('discord-connector.public.remove', ['discord_role_id' => $filter->discord_role_id]) }}" type="button" class="btn btn-danger btn-xs col-xs-12">
